...
public class CharBuilder {
	...
	/**
	 * Converts a 2D array of chars to a Maze.
	...
	/**
	 * Usa MazeBuilder() para gerar um layout (2D Array of chars) and then converts it to a Maze.
	 * @param dimension - dimension of the maze
	 * @param numberOfDragons - number of the dragons in the maze
	 * @return Maze equivalent to layout generated by MazeBuilder
	 */
